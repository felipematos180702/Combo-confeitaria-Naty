  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-6 pt-[6vh] pb-[4vh] md:py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 bg-eggshell overflow-hidden pointer-events-none" style={{ transform: 'translateZ(0)' }}>
        ...
        <div className="absolute top-0 left-0 right-0 h-40 bg-gradient-to-b from-[#3D2314]/60 to-transparent pointer-events-none md:hidden" />
      ...
      >
        ...
        <span className="font-bold text-[16px] md:text-sm tracking-[0.2em] text-white uppercase flex flex-col md:flex-row items-center [text-shadow:_0_4px_12px_rgba(61,35,20,0.8),0_2px_4px_rgba(61,35,20,0.4)] md:[text-shadow:_0_0_20px_rgba(74,60,42,0.4),0_10px_20px_rgba(74,60,42,0.2)] md:bg-gradient-to-b md:from-white md:to-[#f0e6d2] md:bg-clip-text md:text-transparent">
